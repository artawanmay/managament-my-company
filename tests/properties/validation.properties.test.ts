...
describe("Input Validation Properties", () => {
  ...
  it(
    ...
    () => {
      fc.assert(
        fc.property(fc.double({ min: -1e10, max: -0.0001 }), (negativeNum) => {
      ...
      fc.assert(
        fc.property(
          ...
          (maxLength, baseString) => {
            ...
            const tooLongString = baseString.repeat(
              Math.ceil((maxLength + 1) / Math.max(baseString.length, 1))
            );
  ...
  it(
    ...
    () => {
      fc.assert(
        fc.property(
          fc.record({
            picName: fc.option(fc.string({ maxLength: 255 }), {
              nil: undefined,
            }),
      ...
      fc.assert(
        fc.property(
          fc.record({
            ...
            port: fc.option(fc.integer({ min: 0, max: 65535 }), {
              nil: undefined,
            }),
            username: fc.option(fc.string({ maxLength: 255 }), {
              nil: undefined,
            }),
          }),
          (partialNote) => {
