...
import type { MoveTaskInput, Task, TaskListResponse, TaskStatus } from '../types';
...
export function useMoveTask() {
  ...
  return useMutation({
    ...
    onMutate: async ({ taskId, data, projectId }): Promise<OptimisticContext> => {
