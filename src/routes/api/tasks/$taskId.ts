    ...
    handlers: {
      ...
      GET: async ({ request, params }) => {
        ...
        try {
          ...
          logError("[GET /api/tasks/:taskId] Error", {
      ...
      PUT: async ({ request, params }) => {
        ...
        try {
          ...
          if (parsed.data.linkedNoteId !== undefined)
            updateData.linkedNoteId = parsed.data.linkedNoteId;
          ...
          logError("[PUT /api/tasks/:taskId] Error", {
            error: error instanceof Error ? error.message : String(error),
          });
      ...
      DELETE: async ({ request, params }) => {
        ...
        try {
          ...
          logError("[DELETE /api/tasks/:taskId] Error", {
            error: error instanceof Error ? error.message : String(error),
          });
